 ...
 in ( LrTable.NT 2, ( result, Expr1left, CLOSEBRACK1right), rest671)
...
|  ( 29, ( ( _, ( _, _, CLOSECBRACK1right)) :: ( _, ( MlyValue.Prog 
Prog1, _, _)) :: ( _, ( _, OPENCBRACK1left, _)) :: rest671)) => let
 val  result = MlyValue.AtomExpr (fn _ => let val  (Prog as Prog1) = 
Prog1 ()
 in (Prog)
end)
 in ( LrTable.NT 3, ( result, OPENCBRACK1left, CLOSECBRACK1right), 
rest671)
end
|  ( 30, ( ( _, ( _, _, CLOSEPAREN1right)) :: ( _, ( MlyValue.Comps 
Comps1, _, _)) :: ( _, ( _, OPENPAREN1left, _)) :: rest671)) => let
 val  result = MlyValue.AtomExpr (fn _ => let val  (Comps as Comps1) =
 Comps1 ()
 in (List Comps)
end)
 in ( LrTable.NT 3, ( result, OPENPAREN1left, CLOSEPAREN1right), 
rest671)
end
|  ( 31, ( ( _, ( _, _, CLOSEPAREN1right)) :: ( _, ( MlyValue.Expr 
Expr1, _, _)) :: ( _, ( _, OPENPAREN1left, _)) :: rest671)) => let
 val  result = MlyValue.AtomExpr (fn _ => let val  (Expr as Expr1) = 
Expr1 ()
 in (Expr)
end)
 in ( LrTable.NT 3, ( result, OPENPAREN1left, CLOSEPAREN1right), 
...
|  ( 38, ( ( _, ( _, _, CLOSEPAREN1right)) :: ( _, ( _, OPENPAREN1left
, _)) :: rest671)) => let val  result = MlyValue.Const (fn _ => (
List []))
 in ( LrTable.NT 5, ( result, OPENPAREN1left, CLOSEPAREN1right), 
rest671)
end
|  ( 39, ( ( _, ( _, _, CLOSEPAREN1right)) :: _ :: _ :: ( _, ( 
MlyValue.Type Type1, _, _)) :: ( _, ( _, OPENPAREN1left, _)) :: 
...
|  ( 45, ( ( _, ( _, USCORE1left, USCORE1right)) :: rest671)) => let
 ...
 in ( LrTable.NT 8, ( result, USCORE1left, USCORE1right), rest671)
end
|  ( 46, ( ( _, ( _, _, CLOSEPAREN1right)) :: ( _, ( _, OPENPAREN1left
, _)) :: rest671)) => let val  result = MlyValue.Args (fn _ => ([]))
 in ( LrTable.NT 9, ( result, OPENPAREN1left, CLOSEPAREN1right), 
rest671)
end
|  ( 47, ( ( _, ( _, _, CLOSEPAREN1right)) :: ( _, ( MlyValue.Params 
Params1, _, _)) :: ( _, ( _, OPENPAREN1left, _)) :: rest671)) => let
...
|  ( 52, ( ( _, ( _, _, CLOSEPAREN1right)) :: ( _, ( MlyValue.Types 
Types1, _, _)) :: ( _, ( _, OPENPAREN1left, _)) :: rest671)) => let
 val  result = MlyValue.Type (fn _ => let val  (Types as Types1) = 
Types1 ()
 in (ListT Types)
end)
 in ( LrTable.NT 12, ( result, OPENPAREN1left, CLOSEPAREN1right), 
rest671)
end
|  ( 53, ( ( _, ( _, _, CLOSEBRACK1right)) :: ( _, ( MlyValue.Type 
Type1, _, _)) :: ( _, ( _, OPENBRACK1left, _)) :: rest671)) => let
 val  result = MlyValue.Type (fn _ => let val  (Type as Type1) = Type1
 ()
 in (SeqT Type)
end)
 in ( LrTable.NT 12, ( result, OPENBRACK1left, CLOSEBRACK1right), 
rest671)
end
...
|  ( 58, ( ( _, ( _, _, CLOSEPAREN1right)) :: ( _, ( MlyValue.Type 
Type1, _, _)) :: ( _, ( _, OPENPAREN1left, _)) :: rest671)) => let
 val  result = MlyValue.AtomType (fn _ => let val  (Type as Type1) = 
Type1 ()
 in (Type)
end)
 in ( LrTable.NT 13, ( result, OPENPAREN1left, CLOSEPAREN1right), 
rest671)
end
...
ParserData.MlyValue.VOID,p1,p2))
fun NEGATIVE (p1,p2) = Token.TOKEN (ParserData.LrTable.T 9,(
ParserData.MlyValue.VOID,p1,p2))
...
ParserData.MlyValue.VOID,p1,p2))
fun MULTIPLIER (p1,p2) = Token.TOKEN (ParserData.LrTable.T 17,(
ParserData.MlyValue.VOID,p1,p2))
fun DIVIDER (p1,p2) = Token.TOKEN (ParserData.LrTable.T 18,(
ParserData.MlyValue.VOID,p1,p2))
fun EQUAL (p1,p2) = Token.TOKEN (ParserData.LrTable.T 19,(
ParserData.MlyValue.VOID,p1,p2))
fun DIFFERENT (p1,p2) = Token.TOKEN (ParserData.LrTable.T 20,(
ParserData.MlyValue.VOID,p1,p2))
fun LESS (p1,p2) = Token.TOKEN (ParserData.LrTable.T 21,(
ParserData.MlyValue.VOID,p1,p2))
fun LESSEQ (p1,p2) = Token.TOKEN (ParserData.LrTable.T 22,(
ParserData.MlyValue.VOID,p1,p2))
fun DOUBLECOLON (p1,p2) = Token.TOKEN (ParserData.LrTable.T 23,(
ParserData.MlyValue.VOID,p1,p2))
...
ParserData.MlyValue.VOID,p1,p2))
fun USCORE (p1,p2) = Token.TOKEN (ParserData.LrTable.T 29,(
ParserData.MlyValue.VOID,p1,p2))
...
ParserData.MlyValue.VOID,p1,p2))
fun OPENPAREN (p1,p2) = Token.TOKEN (ParserData.LrTable.T 36,(
ParserData.MlyValue.VOID,p1,p2))
fun CLOSEPAREN (p1,p2) = Token.TOKEN (ParserData.LrTable.T 37,(
ParserData.MlyValue.VOID,p1,p2))
fun OPENBRACK (p1,p2) = Token.TOKEN (ParserData.LrTable.T 38,(
ParserData.MlyValue.VOID,p1,p2))
fun CLOSEBRACK (p1,p2) = Token.TOKEN (ParserData.LrTable.T 39,(
ParserData.MlyValue.VOID,p1,p2))
fun OPENCBRACK (p1,p2) = Token.TOKEN (ParserData.LrTable.T 40,(
ParserData.MlyValue.VOID,p1,p2))
fun CLOSECBRACK (p1,p2) = Token.TOKEN (ParserData.LrTable.T 41,(
ParserData.MlyValue.VOID,p1,p2))
