...
| 4 => (lex())
| 41 => (LESS(yypos, yypos))
| 44 => (LESSEQ(yypos, yypos))
| 47 => (ARROW(yypos, yypos))
| 50 => (DOUBLEARROW(yypos, yypos))
| 52 => (OPENPAREN(yypos, yypos))
| 54 => (CLOSEPAREN(yypos, yypos))
| 56 => (OPENBRACK(yypos, yypos))
| 58 => (CLOSEBRACK(yypos, yypos))
| 60 => (OPENCBRACK(yypos, yypos))
| 62 => (CLOSECBRACK(yypos, yypos))
